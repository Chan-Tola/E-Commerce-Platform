<form action="{{ route('productdetail.update', $product_detail->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="mb-6">
        ...
        <div class="relative">
            ...
            <input type="number" id="unit_price" name="unit_price" step="0.01" min="0"
                value="{{ old('unit_price', $product_detail->unit_price) }}"
    ...
    <div class="mb-6">
        ...
        <textarea id="admin_notes" name="admin_notes" rows="4"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">{{ old('admin_notes', $product_detail->admin_notes) }}</textarea>
    </div>
